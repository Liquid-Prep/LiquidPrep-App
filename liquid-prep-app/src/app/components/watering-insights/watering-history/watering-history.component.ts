...
import type { SensorsData } from '../../dashboard/sensors/sensors.component';


@Component({
  selector: 'app-watering-history',
  templateUrl: './watering-history.component.html',
  styleUrls: ['./watering-history.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class WateringHistoryComponent implements OnInit {
  sensors: SensorsData;
  sensor: any;
  sensorId: string;
